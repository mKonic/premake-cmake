...
--
	...
	function cmake.wksdir(wks)
		return wks.location .. "/cmake-bins/"
	end
	...
	function cmake.generateWorkspace(wks)
		...
		p.indent("  ")
		p.escaper(cmake.esc)
		-- Create cmake-bins directory
		os.mkdir(wks.location .. "/cmake-bins")
		-- Generate root CMakeLists.txt at workspace location
		p.generate(wks, wks.location .. "/CMakeLists.txt", cmake.workspace.generateRoot)
		-- Generate the cmake-bins CMakeLists.txt that includes all projects
